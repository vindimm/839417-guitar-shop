...
describe('Component: CartItem', () => {
  it('should render correctly', () => {
    ...
    expect(screen.getByText('Честер Bass')).toBeInTheDocument();
    expect(screen.getByTestId('guitar-count-input-testid')).toHaveValue(2);
    fireEvent.click(screen.getByTestId('plus-button-testid'));
    expect(screen.getByTestId('guitar-count-input-testid')).toHaveValue(3);
  });
});
